...
You are playing the following Nim Game with your friend: There is a heap of stones on
the table, each time one of you take turns to remove 1 to 3 stones. The one who removes
...
if __name__ == "__main__":
    total_num_of_stones = int(input("Enter the total number of stones = "))
    print(nim_game(total_num_of_stones))
